                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="#" method="post" enctype='multipart/form-data'>
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="cth : Kunjungan" name="edJudul" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Event Name [Inggris]</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="ex: Visit" name="edJudul_2" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                         <input type="date" name="edData" class="file-upload-browse btn btn-primary" id="" required>
                          </span>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Lokasi Kegiatan</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Lokasi" name="edLokasi" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Event Location</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Location" name="edLokasi_2" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleTextarea1">Deskripsi Kegiatan</label>
                        <textarea name="edDeskripsi" class="form-control" id="exampleTextarea1" rows="4" required></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleTextarea1">Event Description</label>
                        <textarea name="edDeskripsi_2" class="form-control" id="exampleTextarea1" rows="4" required></textarea>
                      </div>
                      <div class="form-group">
