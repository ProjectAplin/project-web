            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tambah Tag Baru </p>
                    <form class="forms-sample" action="#" method="post" enctype='multipart/form-data'>
                      <div class="form-group">
                        <label for="exampleInputName1">Nama Tag</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="cth: Pendidikan" name="edTag" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Name Tag [Inggris]</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="ex: Education" name="edTag_2" required>
                      </div>
