<?php
    ...
    if(isset($_POST['btnSubmit']))
    {
        ...
        if($nama!=""&&$email!="")
        {
            echo "<h1 style='color:white;'>masuk</h1>";
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tambah Dosen Baru </p>
                    <form class="forms-sample" action="#" method="post" enctype='multipart/form-data'>
                      <div class="form-group">
                        <label for="exampleInputName1">Nama</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="edNama" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Email address</label>
                        <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Email" name="edEmail" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="edMatkul" class="form-control" id="exampleTextarea1" rows="4" required></textarea>
                      </div>
                      <div class="form-group">
