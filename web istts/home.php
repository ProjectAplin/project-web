<?php
    ...
    if(isset($_POST['edTmbhTag']))
    {
        header("location:tambahTag.php");
    }

    if(isset($_POST['edUpdateTag']))
    {
        header("location:updateTag.php");
    }
...
<body>
    <form action="#" method="post">
        <h1>Welcome Admin</h1>
        <input type="submit" value="Logout" name="btnLogout"><br>
        ...
        <input type="submit" value="Tambah Tag Baru" name='edTmbhTag'>
        <input type="submit" value="Update Tag" name='edUpdateTag'> <br>
    </form>
</body>
</html>