							...
							<div class="timeline-panel credits  anim animate fadeInLeft">
								<ul class="timeline-panel-ul">
									...
									<div class="righting-wrap">
										...
										<li><span class="causale">STTS pada mulanya dikenal dengan Institut Teknisi Elektro Surabaya (ITES) yang didirikan pada tanggal 1 Maret 1979. ITES berlokasi di jalan Bali no. 17 Surabaya dan dibawah naungan Yayasan Perguruan Tinggi Teknik Nusantara. Penyelenggaraan perguruan tinggi ini didasarkan atas kesadaran untuk ikut berperan serta dalam memenuhi kebutuhan pendidikan tinggi khususnya di bidang teknik elektro.</span> </li>
...
- Diploma-3 Manajemen Informatika dan Teknik Komputer</p>
				...
				<li>
					<a href="#" class="float-left">1997</a><br>
					<p>Pertama kali Depdikbud menerapkan akreditasi, STTS ditetapkan sebagai Perguruan Tinggi Terakreditasi (yang pertama di Indonesia Timur diantara perguruan tinggi swasta jurusan sejenis)</p>
				</li>
				</li>
				<li>
					<a href="#" class="float-left">2000</a><br>
					<p>STTS bekerja sama dengan Swinburne University of Technology (SUT) - Melbourne Australia , menyelenggarakan link program Bachelor of Science Information Technology (BIT) dan program studi lanjut untuk jenjang master di SUT.</p>
				</li>
				</li>
				<li>
					<a href="#" class="float-left">2006</a><br>
					<p>STTS menyelenggarakan program strata-1 Sistem Informasi Bisnis, dengan tujuan menghasilkan sarjana dengan kemampuan yang merupakan perpaduan antara ilmu informatika dan manajemen.</p>
				</li>
				</li>
				<li>
					<a href="#" class="float-left">2008</a><br>
					<p>STTS membuka jurusan Desain Komunikasi Visual dan tiga tahun kemudian , di tahun 2011 STTS membuka jurusan Desain Produk.</p>
				</li>
				</li>
				<li>
					<a href="#" class="float-left">2015</a><br>
					<p>STTS mendapat akreditasi B dari Badan Akreditasi Nasional Perguruan Tinggi (BAN-PT) NoSK: 401/SK/BAN-PT/Akred/V/2015 dan di tahun yang sama, STTS menjalin kerjasama dengan Universitas Dong Eui,Busan, Korea Selatan.</p>
				</li>
				<li>
					<a href="#" class="float-left">2019</a><br>
					<p>Pada tanggal 24 Juni 2019, SK Menteri Nomor 481/KPT/ I /2019 tentang Izin perubahan bentuk nama Sekolah Tinggi Teknik Surabaya (STTS) telah resmi berubah menjadi Institut Sains dan Teknologi Terpadu Surabaya (iSTTS).</p>
